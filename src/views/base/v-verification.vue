...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            mouseMoveFn(e){
                if(this.mouseMoveStata){
                    ...
                    if(width>0 && width<=this.maxwidth){
                        ...
                        if (!this.beginVerification) {
                            this.beginVerification = true;
                            axios({
                                headers: { "Content-Type": "application/json" },
                                method: "post",
                                url: "/userInformation/verification",
                                async: true,
                                data: {
                                    code: window.btoa(JSON.stringify({
                                        beginTimespan: this.beginTimespan,
                                        finishTimespan: Date.now(),
                                    }))
                                },
                                ...
                                if (res.data.code == "200") {
                                    ...
                                    this.beginVerification = false;

                                    if (dom) {
                                        dom.setAttribute('data-verification', '1');
                                    }
                                }
                            })
                            //this.successFunction();
            ...
            moseUpFn(e){
                this.beginTimespan = this.beginTimespan || 0
