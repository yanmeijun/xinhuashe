...
app.use(async (ctx, next) => {
  if (ctx.req.url === '/') {
    return ctx.body = { code: 401, error: "未登录" };
  }
  ...
  const pathNameArr = ["userInformation/login", "userInformation/isLogin", "userInformation/register", "userInformation/isRegister",
    "code/getCode", "code/code", "userInformation/isOnlymobile", "code/retrievePwd", "userInformation/findPassword", "userInformation/verification",
