...
$(function () {
    ...
    getDishonestyDetail()//页面初始化执行
})

// 点击返回按钮
$('#back').on('click', function () {
    var url = "/credit?page=lostTrusteeInquiry&randomKey=" + randomKey + "&userID=" + userID.trim() + "&clientID=" + clientID.trim() + "&cityID=" + cityID.trim() + "&local_x=" + local_x + "&localFrom=" + localFrom +  "&local_y=" + local_y;
...
function getDishonestyDetail() {
    ...
    $.ajax({
        async: "true",
        type: "post",
        url: "/credit/getDishonestyDetails",
        ...
        success: function (data) {
            ...
            if (data.retCode == "000000") {
                ...
                // $('#companyStatus').html(data.responseBody.entstatus);
