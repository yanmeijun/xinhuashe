...
$(function () {
    ...
    getTaxIllegalDetail()//页面初始化执行
})
// 点击返回按钮
$('#back').on('click', function () {
    var url = "/credit?page=taxIllegalInquiry&randomKey=" + randomKey + "&userID=" + userID.trim() + "&clientID=" + clientID.trim() + "&cityID=" + cityID.trim() + "&local_x=" + local_x + "&localFrom=" + localFrom +  "&local_y=" + local_y;
...
function getTaxIllegalDetail() {
    ...
    $.ajax({
        async: "true",
        type: "post",
        url: "/credit/getTaxIllegalDetails",
