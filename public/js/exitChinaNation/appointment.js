...
$('#submit').on("click", function () {
    ...
    $.ajax({
        async: true,
        url: "/exitChinaNation/confirmOrder",
        type: 'post',
        ...
        success: function (res) {
            ...
            if (res.retCode == "000000") {
                var url = "/exitChinaNation?page=appointmentSuccess&randomKey=" + randomKey + "&userID=" + userID + "&clientID=" + clientID + "&cityID=" + cityID + "&local_x=" + local_x + "&localFrom=" + localFrom +  "&local_y=" + local_y;
                window.location.href = url;//跳转到对应的页面
            } else {
                var url = "/exitChinaNation?page=appointmentFailed&randomKey=" + randomKey + "&userID=" + userID + "&clientID=" + clientID + "&cityID=" + cityID + "&local_x=" + local_x + "&localFrom=" + localFrom +  "&local_y=" + local_y;
                window.location.href = url;//跳转到对应的页面
            }
        },
