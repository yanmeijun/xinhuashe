...
html += template.replace(RegResources.nameReg, data.xm)
    ...
    .replace(RegResources.yyhReg, data.idCard)
$("#calculatorBox").html(html);


$('#back').on("click", function () {
    var url = "/chainCard?page=appointment&randomKey=" + randomKey + "&userID=" + userID + "&clientID=" + clientID + "&cityID=" + cityID + "&local_x=" + local_x + "&localFrom=" + localFrom +  "&local_y=" + local_y;
