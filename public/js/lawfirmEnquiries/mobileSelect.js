    ...
    MobileSelect.prototype = {
        ...
        init: function (config) {
            ...
            _this.ensureBtn.addEventListener('click', function () {
                ...
                var tempValue = '', tempDataId = '';
                for (var i = 0; i < _this.wheel.length; i++) {
                    if(_this.getValue(i) == "请选择" || _this.getDataId(i) == "undefined" ){
                        continue;
                    }
                    i == _this.wheel.length - 1 ? tempValue += _this.getValue(i) : tempValue += _this.getValue(i) + ' ';
                    i == _this.wheel.length - 1 ? tempDataId += _this.getDataId(i) : tempDataId += _this.getDataId(i) + ' ';
                }
                _this.trigger.innerHTML = tempValue;
                _this.trigger.setAttribute("data_id", tempDataId);
                ...
                (function (i) {
                    ...
                    if (_this.wheel[i]) {
                        ...
                        for (var j = 0; j < _this.displayJson[i].length; j++) { //行
                            tempHTML += '<li data-id="' + _this.displayJson[i][j].id + '">' + _this.displayJson[i][j].name + '</li>';
                        }
        ...
        updateWheel: function(sliderIndex, data){
            ...
            if(_this.cascade){
                ...
                for(var j=0; j<data.length; j++){
                    tempHTML += '<li data-id="'+data[j].id+'">'+data[j].name+'</li>';
                }
        ...
        touch: function (event, theSlider, index) {
            ...
            switch (event.type) {
                ...
                case "touchend":
                    ...
                    _this.transitionEnd(_this.getIndexArr(), _this.getJson(),index);
