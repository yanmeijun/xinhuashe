    ...
    $.ajax({
        ...
        success: function (res) {
            if (res.retCode == "000000") {
                ...
                var url = "/jrzggjspcs?page=appointment&randomKey=" + randomKey + "&userID=" + userID + "&clientID=" + clientID + "&cityID=" + cityID + "&local_x=" + local_x + "&localFrom=" + localFrom +  "&local_y=" + local_y;
