...
var back = function () {
    ...
    goBack.onclick = function () {
        var url = "/dutyCrimeReport?page=dutyCrimeReport&randomKey=" + randomKey + "&userID=" + userID + "&clientID=" + clientID + "&cityID=" + cityID + "&local_x=" + local_x + "&localFrom=" + localFrom + "&local_y=" + local_y;
