  ...
  export default {
    ...
    watch:{
      $route(to,from){
        ...
        if(to.path == "/serviceSupport/commonProblem"){
          childNodes[0].className = "active";
        }else if(to.path == "/serviceSupport/teacherRelated"){
          childNodes[1].className = "active";
        }else if(to.path == "/serviceSupport/operationRelated"){
          childNodes[2].className = "active";
        }else if(to.path == "/serviceSupport/helpCenter"){
          childNodes[3].className = "active";
        }else if(to.path == "/serviceSupport/disclaimer"){
          childNodes[4].className = "active";
        }
      }
    }
  }
