          ...
          <div class="rm-main-content">
            <table class="mainTable fwjr">
              ...
              <tr>
                ...
                <th>服务名称</th>
                <!--<th>服务范围</th>-->
                <!--<th class="percent10">服务地址</th>-->
                <!--<th>服务简介</th>-->
                <!--<th class="percent10">服务logo</th>-->
                <th style="width: 18%">templateID</th>
                <th style="width: 18%">服务url</th>
              ...
              <tr v-for="(item ,index) in serviceListArr" :key="index">
                ...
                <!--<td>河南省</td>-->
                <!--<td>{{item.url}}</td>-->
                <!--<td><span class="clampHide" :title="item.summary">{{item.summary}}</span></td>-->
                <!--<td>{{item.logo}}</td>-->
                ...
                <td>
                  <div class="rm-main-icon-box" @click="modify(item.serviceID)">
