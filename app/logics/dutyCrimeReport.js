...
let dutyCrimeReportService = {};

dutyCrimeReportService.postData = (params, next) => {
    return new Promise((resolve, reject) => {
        ...
        console.log("最高人民检察院职务犯罪举报taskId：" + body.taskId);
        util.postData(url, options, (err, body) => {
            if (err) {
                console.error("最高人民检察院职务犯罪举报错误：" + err);
                reject(err)
            }
            resolve(body);
        })
...
exports.dutyCrimeReportService = dutyCrimeReportService;