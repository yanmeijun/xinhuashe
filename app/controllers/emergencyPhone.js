const urlParse = require('url'),
    ...
    emergencyPhoneService = require("../logics/emergencyPhone").emergencyPhoneService;
let path = "emergencyPhone/";
const serviceID = "HAB0005", templateID = "telSelect";
let emergencyPhoneCon = {};

emergencyPhoneCon.getCon = (req, res, next) => {
...
const pageCon = (req, res, next) => {
    ...
    console.log("领事保护应急电话查询renderName: " + renderName);
...
const apiCon = (req, res, next) => {
    ...
    console.log("领事保护应急电话查询请求方法名: " + pathName);
    if (!pathName) return;
    eval(pathName + "(req, res, next)");
};
const telSearch = (req, res, next) => {
    const params = {
    ...
    if (util.isEmptyValue("emergencyPhoneCon.telSearch", params)) {
...
exports.emergencyPhoneCon = emergencyPhoneCon;